  ...
  <main class="w-full flex flex-col">
    ...
    <section
      ...
      <div
        ...
        <div
          class="px-3  border-[1.5px] border-solid border-primary-5 group hover:border-primary-2 transition-all duration-300 py-2 rounded-md bg-primary-4 place-content-center"
